...
Developer-facing Kubernetes tooling: web and desktop UIs, editor extensions, CI
actions, and containerization tooling.
...
| Project | Contributors |
|---------|--------------|
| [Azure/k8s-gh-action-toolkit](https://github.com/Azure/k8s-gh-action-toolkit) and the actions it covers — [k8s-deploy](https://github.com/Azure/k8s-deploy), [k8s-bake](https://github.com/Azure/k8s-bake), [k8s-lint](https://github.com/Azure/k8s-lint), [setup-helm](https://github.com/Azure/setup-helm), [setup-kubectl](https://github.com/Azure/setup-kubectl), [aks-set-context](https://github.com/Azure/aks-set-context) | `davidgamero`, `bosesuneha`, `ejaifeobuks` |
| [Azure/containerization-assist](https://github.com/Azure/containerization-assist) | `ejaifeobuks`, `davidgamero`, `bosesuneha` |
| [Azure/draft](https://github.com/Azure/draft) | `davidgamero`, `bosesuneha` |
